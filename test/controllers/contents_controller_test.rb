...
class ContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content" do
    assert_difference("Content.count") do
      post contents_url, params: { content: { picture_id: @content.picture_id, user_id: @content.user_id } }
    end
  ...
  test "should update content" do
    patch content_url(@content), params: { content: { picture_id: @content.picture_id, user_id: @content.user_id } }
